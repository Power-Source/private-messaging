...
*   For WordPress Multisite installs – Activate it blog-by-blog (say if you wanted to make it a [Pro Sites](https://premium.wpmudev.org/project/pro-sites/ "WordPress Pro Sites Plugin - PSOURCE") premium plugin), or visit Network Admin -> Plugins and Network Activate the plugin. Note that there are no network settings for this plugin.
