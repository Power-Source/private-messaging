...
if (!class_exists('MM_User_Capability')) {
    class MM_User_Capability
    {
        ...
        function setting_content()
        {
            ...
            (function() {
                ...
                function initCapabilityTabs() {
                    ...
                    var tabLinks = document.querySelectorAll('.nav-pills a[data-toggle="tab"]');
                    ...
                    tabLinks.forEach(function(link) {
                        link.addEventListener('click', function(e) {
                            ...
                            // Find the parent container (only work within this specific row)
                            var container = this.closest('.row');
                            if (!container) return;

                            // Remove active class from all tabs within this container
                            var allTabs = container.querySelectorAll('.nav-pills li');
                            var allPanes = container.querySelectorAll('.tab-content .tab-pane');
        ...
        {
            ?>
            <li role="presentation" class="<?php echo mmg()->get('tab') == 'cap' ? 'active' : null ?>">
                <a href="<?php echo esc_url(add_query_arg('tab', 'cap')) ?>" role="tab" class="mm-tab-link" data-tab="cap" data-target="#cap">
