...
if (!class_exists('IG_Uploader_Controller')) {
    class IG_Uploader_Controller
    {
        ...
        function load_upload_form()
        {
            ...
            $this->load_template_part('_uploader_form', array(
                'model' => $model
            ));
            exit;
        }
        ...
        function show_media($model, $attribute)
        {
            ...
            $this->load_template_part('show_media', array(
                'models' => $models
            ));
        }
        ...
        {
            if ($return) {
                return $this->load_template_part(apply_filters('igu_single_file_template', '_single_file'), array(
                    'model' => $model
                ), false);
            }
            $this->load_template_part(apply_filters('igu_single_file_template', '_single_file'), array(
                'model' => $model
            ));
        }
        ...
        public function _extend_form($models, $attribute, $target_model, $is_admin, $attributes = array())
        {
            ...
            $this->load_template_part('_extend_form', array(
                'models' => $models,
                'tmodel' => $target_model,
                'attribute' => $attribute,
                'target_id' => $this->build_id($target_model, $attribute),
        ...
        {
            $this->load_template_part('footer_modal', array(
