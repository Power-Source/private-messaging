 ...
 * @since 1.0.0
 */
class MMessage_Backend_Controller
{
    use Template_Loader_Trait;
    
    public function __construct()
    {
        $this->template_base_path = dirname(dirname(__DIR__)) . '/views/';
    ...
    function setting()
    {
        ...
        $this->load_template_part('backend/setting', array(
            'model' => $model
        ));
    }
    ...
    {
        $this->load_template_part('backend/setting/shortcode');
    }

    function general_view($model)
    {
        $this->load_template_part('backend/setting/general', array(
            'model' => $model
        ));
    }
    ...
    {
        $this->load_template_part('backend/setting/email', array(
            'model' => $model
        ));
    }
    ...
    function attachment_view($model)
    {
        ...
        $this->load_template_part('backend/setting/attachment', array(
            'model' => $model
        ));
    }
}