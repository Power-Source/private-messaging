...
if (!class_exists('IG_Model')) {
    class IG_Model
    {
         ...
         * @return void
         */
        public function set_error(string $field, string $message): void
        {
         ...
         * @return void
         */
        public function import(array $data = array()): void
        {
        ...
        public function fetch_array(array $data): array
        {
         ...
         * @return void
         */
        public function set_exist(bool $exist): void
        {
            $this->exist = $exist;
        }
         ...
         * @return array
         */
        public function get_mapped(): array
        {
            return $this->mapped;
        }
        ...
        /**
         * Recursively implode nested arrays
         *
         * @param array $array
         * @param string $glue
         * @return string
         */
        public function multi_implode(array $array, string $glue): string
        {
            $ret = '';
